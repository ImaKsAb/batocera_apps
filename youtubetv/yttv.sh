...
APPLINK=https://github.com/ImaKsAb/batocera_apps/raw/main/youtubetv/extra/YouTubeonTV-linux-x64.zip
APPHOME=github.com/ImaKsAb/batocera_apps
#---------------------------------------------------------------------
...
mkdir -p ~/pro/.dep 2>/dev/null && cd ~/pro/.dep && wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O ~/pro/.dep/dep.zip https://github.com/ImaKsAb/batocera_apps/raw/main/.dep/dep.zip && yes "y" | unzip -oq ~/pro/.dep/dep.zip && cd ~/
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/ImaKsAb/batocera_apps/raw/main/$appname/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
url=https://github.com/ImaKsAb/batocera_apps/raw/main/
cd $temp
...
wget -q -O "/userdata/roms/ports/YoutubeTV.sh.keys" "https://raw.githubusercontent.com/ImaKsAb/batocera_apps/main/youtubetv/extra/YoutubeTV.sh.keys"
# --------------------------------------------------------------------
